...
func Test(t *testing.T) {
	...
	terraformOptions := &terraform.Options{
		...
		TerraformDir: "../../_example/aurora-mysql-serverless",
	}
	...
	assert.Equal(t, "test-clouddrove-aurora-mysql-serverless", Tags["Name"])
	assert.Equal(t, "test-clouddrove-aurora-mysql-serverless", clusterID[0])
}
